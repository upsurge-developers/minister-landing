                ...
                <div className="col-span-3 grid grid-cols-1 grid-rows-6 gap-8 md:grid-cols-3 md:grid-rows-2">
                    <div className="rows-span-1 col-span-1">
                        <div className="align-center m-0 flex h-full w-full  flex-col rounded-md px-5 py-12 text-center shadow-xl bg-gray-900 sm:px-8">
                            <div className="flex justify-center">
                                <Airplay className="animate-slow-bounce rounded-full p-1 text-center text-6xl" />
                            </div>
                    ...
                    <div className="rows-span-1 col-span-1">
                        <div className="align-center m-0 flex h-full w-full  flex-col rounded-md px-8 py-12 text-center shadow-xl bg-gray-900">
                            <div className="flex justify-center">
                                <UsersThree className="animate-slow-bounce rounded-full p-1 text-center text-6xl" />
                            </div>
                            <h3 className=" mt-4 text-[21px] font-bold">
                    ...
                    <div className="cols-span-1 rows-span-1">
                        <div className="align-center m-0 flex h-full w-full  flex-col rounded-md px-8 py-12 text-center shadow-xl bg-gray-900">
                            <div className="flex justify-center">
                                <PlugsConnected className="animate-slow-bounce rounded-full p-1 text-center text-6xl" />
                            </div>
                    ...
                    <div className="rows-span-1 col-span-1">
                        <div className="align-center m-0 flex h-full w-full  flex-col rounded-md px-8 py-12 text-center shadow-xl bg-gray-900">
                            <div className="flex justify-center">
                                <HandsPraying className="animate-slow-bounce rounded-full p-1 text-center text-6xl" />
                            </div>
                    ...
                    <div className="cols-span-1 rows-span-1">
                        <div className="align-center m-0 flex h-full w-full  flex-col rounded-md px-8 py-12 text-center shadow-xl bg-gray-900">
                            <div className="flex justify-center">
                                <HandCoins className="animate-slow-bounce rounded-full p-1 text-center text-6xl" />
                            </div>
                            <h3 className=" mt-4 text-[21px] font-bold">
                    ...
                    <div className="cols-span-1 rows-span-1">
                        <div className="align-center m-0 flex h-full w-full  flex-col rounded-md px-8 py-12 text-center shadow-xl bg-gray-900">
                            <div className="flex justify-center">
                                <Layout className="animate-slow-bounce rounded-full p-1 text-center text-6xl" />
                            </div>
                            <h3 className=" mt-4 text-[21px] font-bold">
